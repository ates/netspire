...
%% +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
%% |  Attributes ...
-define(RADIUS_PACKET, Code:8, Ident:1/binary, Length:16,
    Auth:16/binary, Attrs/binary).
...
-type radius_attribute() :: {integer() | tuple(), atom(), string(), any()}.
-type radius_value() :: {string(), string(), any()}.
-type nas_spec() :: {inet:ip_address(), any(), string(), module()}.
